...
app.get('/api/accounts', authCheck, (req, res) => {
...
app.get('/api/account/:id', authCheck, (req, res) => {
...
app.post('/api/create-account', authCheck, (req, res) => {
...
app.post('/api/transfer-funds', authCheck, (req, res) => {
...
app.get('/api/all-currencies', (req, res) => {
...
app.get('/api/currencies', authCheck, (req, res) => {
	const myCurrencies = data.mine.currencies || {}
	res.end(response(myCurrencies))
})

app.post('/api/currency-buy', authCheck, (req, res) => {
	const { from, to, amount: rawAmount } = (req.body || {})
	const myCurrencies = data.mine.currencies || {}
